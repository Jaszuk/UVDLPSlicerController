...
namespace UV_DLP_3D_Printer
{
    ...
    public class Slice
    {
        ...
        public Bitmap RenderSlice(SliceParms sp) 
        {
            ...
            for (int y = mm.ymin; y < mm.ymax; y++) 
            {
                ...
                {
                    SysLog.Instance().Log("Row y=" + y + " odd # of points = " + points.Count);
                }
            }
        ...
        private ArrayList GetIntersectingPoints(int ypos, ArrayList lines) 
        {
            ...
            foreach (Line2d ln in lines) 
            {
                ...
                else if (ln.p1.y == ypos) // point 1 endpoint is on the line, add it twice
                {
                ...
                else if (ln.p2.y == ypos) // point 2 endpoint is on the line, add it twice
                {
                    //If the intersection is the ymin of the edge’s
                    //endpoint, count it. Otherwise, don’t
        ...
        private ArrayList Get2dLines(SliceParms sp) 
        {
